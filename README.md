The GitHub repository includes the code and interactive dashboard that were created to visualize player performance ratings, compare lineup scenarios and generate optimal recommendations.
